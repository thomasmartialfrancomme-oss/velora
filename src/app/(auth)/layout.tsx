    ...
    <div className="relative grid min-h-svh lg:grid-cols-[1.05fr_0.95fr]">
      <aside className="relative hidden flex-col justify-between overflow-hidden border-r border-ivory-200/[0.07] bg-ink-1000 px-14 py-14 lg:flex">
        ...
        <div className="relative max-w-md">
          ...
          <p className="font-serif text-[clamp(1.9rem,2.6vw,2.7rem)] font-light leading-[1.22] text-ivory-50">
            The households that need this least
            <br />
            are the ones already running it.
          </p>
          <p className="mt-8 max-w-sm text-[13.5px] leading-relaxed text-graphite-300">
            This is where your residences, your people, your travel and your ledger meet — behind one door, visible to no one else.
          </p>
        ...
        <div className="relative flex items-end justify-between gap-6">
          ...
          <p className="text-[10.5px] uppercase tracking-[0.2em] text-graphite-600">VELORA PRIVATE</p>
        </div>
      </aside>
